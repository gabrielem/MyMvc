<?php 
$selectCat=$htmlHelper->filtroRelazione($tab,$tab2[0],$tipoRelazioneDB,"id2",$FILTRO_id2); 
?>
<?php if($paginate){ ?>
<p>
...
<?php if($dati){ ?>
	...
	<?php $ii++; ?>	<td><?php echo date("m-d-Y",$dati[$i]['data']); ?></td>
	<?php $ii++; ?>	<td><?php echo $dati[$i]['id_crm_ordini']; ?></td>
	<?php $ii++; ?>	<td><?php echo $dati[$i]['qta_attuale']; ?></td>
