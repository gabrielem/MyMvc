...
<?php if($dati){ ?>
	...
	<?php $ii++; ?>	<td><?php echo $dati[$i][euro]; ?></td>
	<?php $ii++; ?>	<td><?php echo $dati[$i][special_gift]; ?></td>
	<?php $ii++; ?>	<td><?php echo $dati[$i][testo_breve]; ?></td>
	<?php $ii++; ?>	<td><?php echo $dati[$i][testo]; ?></td>
	<?php $ii++; ?>	<td><?php echo $dati[$i][visibile]; ?></td>
	<?php $ii++; ?>	<td><?php echo $htmlHelper->filtraCampi($tab,$dati[$i],$campi[$ii],$dati[$i]['posizione']); ?></td>
