...
<?php if($dati){ ?>
	...
	<th>nome</th>
	<th>nome_uri</th>
	<th>id_crm_prodotti_tipi</th>
	<th>id_crm_prodotti_cat</th>
	<th>descrizione</th>
	<th>codice</th>
	<th>id_crm_ditte</th>
	<th></th>
	...
	<?php $ii++; ?>	<td><?php echo $dati[$i][id_crm_prodotti_tipi]; ?></td>
	<?php $ii++; ?>	<td><?php echo $dati[$i][id_crm_prodotti_cat]; ?></td>
	<?php $ii++; ?>	<td><?php echo $dati[$i][descrizione]; ?></td>
	<?php $ii++; ?>	<td><?php echo $dati[$i][codice]; ?></td>
	<?php $ii++; ?>	<td><?php echo $dati[$i][id_crm_ditte]; ?></td>
